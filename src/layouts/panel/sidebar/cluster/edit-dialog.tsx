...
export default function ClusterEditDialog({
  id,
  name,
  icon,
}: {
  ...
  return (
    <DialogContent className="sm:max-w-[425px]">
      <DialogHeader>
        <DialogTitle>
          {t("panel.sidebar.cluster.edit.dialog.title")}
        </DialogTitle>
        <DialogDescription>
      ...
      <div className="grid gap-4">
        <div className="grid gap-3">
          <Label htmlFor="name">
            {t("panel.sidebar.cluster.edit.dialog.name")}
          </Label>
          <Input
            id="name"
            name="name"
      ...
      <DialogFooter>
        <DialogClose asChild>
          <Button variant="outline">
            {t("panel.sidebar.cluster.edit.dialog.cancel")}
          </Button>
        </DialogClose>
