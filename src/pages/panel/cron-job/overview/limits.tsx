      ...
      <div className="overflow-y-auto flex-1 pr-2">
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.cron-job.overview.limits.concurrency.policy")}
          </span>
        ...
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t(
              "panel.page.cron-job.overview.limits.successful.jobs.history.limit",
            )}
          </span>
        ...
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.cron-job.overview.limits.failed.jobs.history.limit")}
          </span>
