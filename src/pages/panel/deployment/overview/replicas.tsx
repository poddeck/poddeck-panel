      ...
      <div className="overflow-y-auto flex-1 pr-2">
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.deployment.overview.replicas.replicas")}
          </span>
          <span>{deployment?.replicas}</span>
        </div>
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.deployment.overview.replicas.updated")}
          </span>
          <span>{deployment?.updated_replicas}</span>
        </div>
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.deployment.overview.replicas.ready")}
          </span>
          <span>{deployment?.ready_replicas}</span>
        </div>
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.deployment.overview.replicas.available")}
          </span>
          <span>{deployment?.available_replicas}</span>
        </div>
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.deployment.overview.replicas.unavailable")}
          </span>
