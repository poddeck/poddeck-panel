      ...
      <div className="overflow-y-auto flex-1 pr-2">
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.daemon-set.overview.replicas.desired")}
          </span>
          <span>{daemonSet?.desired_number_scheduled}</span>
        </div>
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.daemon-set.overview.replicas.current")}
          </span>
          <span>{daemonSet?.current_number_scheduled}</span>
        </div>
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.daemon-set.overview.replicas.ready")}
          </span>
          <span>{daemonSet?.number_ready}</span>
        </div>
        <div className="flex justify-between mb-1">
          <span className="text-primary/60">
            {t("panel.page.daemon-set.overview.replicas.up-to-date")}
          </span>
