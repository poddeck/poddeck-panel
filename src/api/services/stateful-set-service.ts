...
const list = () =>
  client.get<StatefulSetListResponse>({ url: StatefulSetApi.List });
const listCluster = (clusterId: string) =>
  client.get<StatefulSetListResponse>({
    url: StatefulSetApi.List,
    headers: {
      Cluster: clusterId,
    },
  });
const find = (data: StatefulSetFindRequest) =>
  client.post<StatefulSetFindResponse>({
    url: StatefulSetApi.Find,
    data,
  });
const create = (data: StatefulSetCreateRequest) =>
  client.post<StatefulSetCreateResponse>({
    url: StatefulSetApi.Create,
    data,
  });
const remove = (data: StatefulSetDeleteRequest) =>
  client.post<StatefulSetDeleteResponse>({
    url: StatefulSetApi.Delete,
    data,
  });
const scale = (data: StatefulSetScaleRequest) =>
  client.post<StatefulSetScaleResponse>({
    url: StatefulSetApi.Scale,
    data,
  });
const restart = (data: StatefulSetRestartRequest) =>
  client.post<StatefulSetRestartResponse>({
    url: StatefulSetApi.Restart,
    data,
  });
const edit = (data: StatefulSetEditRequest) =>
  client.post<StatefulSetEditResponse>({
