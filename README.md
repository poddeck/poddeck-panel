...
It visualizes cluster status, workloads, events, and allows operators to interact with clusters in real time.

## Status

|      | Build Status                                                                       |
|------|------------------------------------------------------------------------------------|
| main | ![CI](https://github.com/poddeck/poddeck-panel/actions/workflows/ci.yml/badge.svg) |